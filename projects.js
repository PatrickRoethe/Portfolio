  ...
  const projectDetails = {
    ...
    2: {
      ...
      description: `
                    ...
                    <br><strong>Experiences</strong>
                    <p>Developing this science center website has been an immensely enriching experience in web development. Working on this project, I gained hands-on experience with several key aspects of modern web design, including creating responsive layouts, helping in implementing engaging animations, and aiding in developing intuitive navigation systems. Collaborating with Kenneth Sheikh, each of us took responsibility for at least two pages, ensuring a cohesive and comprehensive final product. The project also involved making thoughtful design decisions aimed at creating a kid-friendly and educational platform. With a fitting design. While the current version of the website meets our initial goals, we recognize areas for improvement and plan to make further enhancements post-delivery. This experience has significantly broadened my skills, particularly in collaborative development and dynamic design, and I will continue to revisit and refine the project to keep my competencies up to date.</p>
                    `,
      imgSrc:
